...
//
//  Created by shunsuke.miyano on 2021/07/04.
//
...
class ChartViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        chartView.xAxis.labelTextColor = colors.orange
        chartView.doubleTapToZoomEnabled = false
        chartView.delegate = self
        chartView.pinchZoomEnabled = false
        chartView.leftAxis.labelTextColor = colors.orange
    ...
    func dataSet() {
        ...
        set.valueTextColor = colors.orange
